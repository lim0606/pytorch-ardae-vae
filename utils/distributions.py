...
'''
https://github.com/nicola-decao/s-vae-pytorch/blob/master/hyperspherical_vae/distributions/hyperspherical_uniform.py
'''
def sample_hypershperical_uniform_bsz_ssz(batch_size, sample_size, device=torch.device('cpu')):
    ...
    output = torch.zeros(batch_size, sample_size, 1).normal_(0, 1)
