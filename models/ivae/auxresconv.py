...
class Encoder(nn.Module):
    def __init__(self,
        ...
        self.aux_encode = AuxEncoder(z0_dim=z0_dim, c_dim=c_dim, act=nn.ELU(), do_center=do_center, clip_logvar='spm4')
        self.encode = _Encoder(z0_dim=z0_dim, z_dim=z_dim, c_dim=c_dim, act=nn.ELU(), do_center=do_center, clip_logvar='spm4')
